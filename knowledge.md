...
<!-- Auto-injected by agentic-cortex at 2026-07-21T04:00:31.697Z -->
...
- README v4.7.0 update (★0)
## Codebase Graph
*49 source files | 0 API routes | Generated 2026-07-21T03:59:54.174Z*
...
### Data Flow
`API → Service`
Files per layer: UI=0 API=1 Service=41 Data=0
...
- `src/core/rules.js` — fns: _checkCondition(db, rule, context), _executeAction(db, rule, context), defineRule(db, def, persist), deleteRule(db, id), evaluate(db, event, context)
